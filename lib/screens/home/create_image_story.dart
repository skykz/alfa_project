                                    ...
                                    : Column(
                                        children: [
                                          SizedBox(
                                            ...
                                            child: BounceButton(
                                              onPressed: () {
                                                storyBloc.setImagePositionState(
                                                    true);
                                              },
                                              iconImagePath:
                                                  storyBloc.getBackColor ==
                                  ...
                                  child: Column(
                                    children: [
                                      SizedBox(
                                        ...
                                        child: BounceButton(
                                          onPressed: () {
                                            if (storyBloc.getChildrenStickers
                                                    .length >
                                                0)
                                              storyBloc
